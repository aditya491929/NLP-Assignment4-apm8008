...
def setup_wandb(args):
    """
    Simple wandb setup. You can customize project/name as you like.
    """
    wandb.init(
        project="nlp_hw4_t5",
...
def initialize_model(args):
    ...
    You either:
      * finetune the pretrained model associated with the 'google-t5/t5-small' checkpoint
      * train a T5 model initialized with the 'google-t5/t5-small' config from scratch
    """
    if args.finetune:
...
def save_model(checkpoint_dir, model, best):
    """
    Save model checkpoint so we can load it later.
    """
...
def load_model_from_checkpoint(args, best):
    """
    Load model from a checkpoint in the experiment directory.
    """
    ...
    # Model architecture must match how we trained it
